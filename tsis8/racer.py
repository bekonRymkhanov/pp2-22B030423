...
car_Own = pygame.image.load('C:/Users/User/Desktop/python/images/greencar.png')
bg = pygame.image.load("C:/Users/User/Desktop/python/images/AnimatedStreet.png")
...
class ownMovement(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.car = pygame.transform.scale(pygame.image.load('C:/Users/User/Desktop/python/images/redcar.png'), (110, 110))
